...
const Verifier = () => {
  ...
  const verifyLoan = async ({ params }) => {
    const idsub = params.userid;
    try {
      const res = await fetch(
        `https://credit-app-backend-nvo2.onrender.com/loan/${idsub}/verify`,
        {
          method: "PATCH",
          headers: {
      ...
      if (res.ok) {
        ...
        setLoanList((prevList) =>
          prevList.map((loan) =>
            loan._id === id ? { ...loan, status: updatedLoan.status } : loan
          )
        );
      }
    } catch (err) {
          ...
          <div>
            <div className="m-2 flex gap-10 flex-row flex-wrap">
              ...
              <div className="border-2 w-60 h-30 flex flex-row">
                ...
                <div className="flex flex-col justify-center items-center">
                  <h2 className="text-2xl font-bold">250000</h2>
                  <div className="text-2xl font-bold">Cash Received</div>
                </div>
              </div>
              ...
              <div className="border-2 w-60 h-30 flex flex-row">
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <div className="text-2xl font-bold">Other Accounts</div>
                </div>
              </div>
